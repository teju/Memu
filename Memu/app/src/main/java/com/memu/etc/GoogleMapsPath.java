...
public class GoogleMapsPath {
    ...
    public String getDirectionsUrl(LatLng origin, LatLng dest, Context context){
        ...
        System.out.println("onPostExecuteParserTask url "+url);
...
// Start downloading json data from Google Directions API
    ...
    private class ParserTask extends AsyncTask<String, Integer, List<List<HashMap<String,String>>> >{
        ...
        protected void onPostExecute(List<List<HashMap<String, String>>> result) {
            ...
            System.out.println("onPostExecuteParserTask "+result.size());
