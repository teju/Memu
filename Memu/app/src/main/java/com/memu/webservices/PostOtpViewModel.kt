...
class PostOtpViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun loadData(mobile: JSONObject,OtpForm : JSONObject) {
        ...
        genericHttpAsyncTask.setUrl(APIs.postOtp)
