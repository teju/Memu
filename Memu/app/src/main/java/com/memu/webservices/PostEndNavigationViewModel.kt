...
class PostEndNavigationViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun loadData(trip_id: String, no_of_kms: Double) {
        ...
        genericHttpAsyncTask.setUrl(APIs.postEndTrip)
        ...
        genericHttpAsyncTask.setPostParams(Keys.NO_OF_KMS, no_of_kms.toString())
