...
class GetVehicleTypeViewModel(application: Application) : BaseViewModel(application) {
            ...
            override fun onPostExecute(response: Response?) {
                ...
                if (json != null) {
                    try {
                        ...
                        obj = gson.fromJson(response!!.content.toString(), VehicleType::class.java)
