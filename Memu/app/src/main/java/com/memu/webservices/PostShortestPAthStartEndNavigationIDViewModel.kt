...
class PostShortestPAthStartEndNavigationIDViewModel(application: Application) : BaseViewModel(application) {
    ...
    var obj: EndNavigationIDResponse? = null
    ...
    fun loadData(action :String) {
            ...
            override fun onPostExecute(response: Response?) {
                ...
                if (json != null) {
                    try {
                        ...
                        obj = gson.fromJson(response!!.content.toString(), EndNavigationIDResponse::class.java)
        ...
        genericHttpAsyncTask.setUrl(APIs.shortestpathstartstop)
        genericHttpAsyncTask.setPostParams(Keys.ACTION,action)
