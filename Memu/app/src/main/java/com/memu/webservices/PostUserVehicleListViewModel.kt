...
import com.memu.etc.*
import com.memu.modules.poolerVehicleList.PoolerVehicleList

class PostUserVehicleListViewModel(application: Application) : BaseViewModel(application) {
    ...
    var obj: PoolerVehicleList? = null
    ...
    fun loadData() {
            ...
            override fun onPostExecute(response: Response?) {
                ...
                if (json != null) {
                    try {
                        ...
                        obj = gson.fromJson(response!!.content.toString(), PoolerVehicleList::class.java)
        ...
        genericHttpAsyncTask.setUrl(APIs.postVehicleList)
