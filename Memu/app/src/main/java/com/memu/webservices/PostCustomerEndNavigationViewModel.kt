...
class PostCustomerEndNavigationViewModel(application: Application) : BaseViewModel(application) {
    ...
    var obj: EndNavigationResponse? = null
    ...
    fun loadData(trip_id: String, no_of_kms: Double,trip_rider_id :String) {
            ...
            override fun onPostExecute(response: Response?) {
                ...
                if (json != null) {
                    try {
                        ...
                        obj = gson.fromJson(response!!.content.toString(), EndNavigationResponse::class.java)
        ...
        genericHttpAsyncTask.setUrl(APIs.postCustomerEndTrip)
