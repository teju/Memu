...
import com.memu.modules.top_earners.TopEarners
import org.json.JSONObject

class GetTopEarnersViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun loadData() {
            ...
            override fun onPostExecute(response: Response?) {
                ...
                if (json != null) {
                    try {
                        ...
                        obj = gson.fromJson(response!!.content.toString(), TopEarners::class.java)
        ...
        genericHttpAsyncTask.setUrl(APIs.gettopearners)
