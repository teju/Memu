...
class PostFollowersListViewModel(application: Application) : BaseViewModel(application) {
    ...
    fun loadData(type: String,request : String) {
        ...
        genericHttpAsyncTask.setUrl(APIs.pendingFriendRequest)
